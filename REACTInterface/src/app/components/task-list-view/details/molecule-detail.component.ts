  ...
  template: `
    <div class="molecule-info-split-container">
      ...
      <div class="ketcher-panel-column">
        <app-ketcher-viewer [molfile]="sdfContent" title="2D Chemical Structure"></app-ketcher-viewer>
      </div>
...
export class MoleculeDetailComponent extends BaseCatalogDetailComponent {
