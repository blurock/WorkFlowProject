...
public class ReadInDatasetWithDatasetCollectionProcess {
     ...
     * @param criteria   (SetOfPropertyValueQueryPairs) set of extra criteria for
     *                   the dataset
     * @param document   The document of the current process
     * @return The response with the JsonArray of dataset class objects.
     * 
     *         This sets up the data for the service
     *         'ReadInDatasetWithDatasetCollectionLabel'
     */
    public static JsonObject process(String maintainer, String dataset, String classname, JsonObject criteria,
            Document document) {
        ...
        try {
            ...
            JsonObject recordid = CreateDocumentTemplate.createTemplate("dataset:DatasetCollectionSetRecordIDInfo",
                    false);
