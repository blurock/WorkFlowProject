  ...
  build: {
    rollupOptions: {
      input: {
        ...
        transactionsequence: resolve(__dirname, 'pages/transactionsequence.html'),
        transactionsequenceInterface: resolve(__dirname, 'pages/transactionsequence-interface.html'),
        transactionsequenceWorkflow: resolve(__dirname, 'pages/transactionsequence-workflow.html'),
      },
    },
  },
})
