 ...
 * 
 *         given the classname and the object in JsonObject form, generate a
 *         label.
...
public enum GenerateStringLabel {
	...
	LabelDerivedFromUID {
		...
		@Override
		String deriveName(String hierclass, String classname, JsonObject object) {
			String name = JsonObjectUtilities.getValueUsingIdentifier(object, ClassLabelConstants.UID);
			return name;
		}

	},
	LabelDerivedFromSessionId {

		@Override
		String deriveName(String hierclass, String classname, JsonObject object) {
			String name = JsonObjectUtilities.getValueUsingIdentifier(object, ClassLabelConstants.SessionId);
			return name;
		}
