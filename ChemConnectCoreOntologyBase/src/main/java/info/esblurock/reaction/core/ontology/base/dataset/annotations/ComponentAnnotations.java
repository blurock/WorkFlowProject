...
public class ComponentAnnotations {
	...
	public String annotationAsString() {
		...
		for (String key : componentAnnoations.keySet()) {
			...
			sb.append("\t\tDescription: ")
					.append(componentAnnoations.getAsJsonObject(key).get("rdfs:comment").getAsString()).append("\n");
		}
		return sb.toString();
	}
	...
	public String toString() {
		...
		for (String key : classificationAnnotations.keySet()) {
			...
			sb.append("\t\tAnnotations: ").append(classificationAnnotations.getAsJsonObject(key).toString())
					.append("\n");
		}
		return sb.toString();
