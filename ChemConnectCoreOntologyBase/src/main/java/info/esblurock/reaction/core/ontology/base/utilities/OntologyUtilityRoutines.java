...
public class OntologyUtilityRoutines {
	 ...
	 * @param direct: true only direct subclasses, false the entire tree of
	 *                subclasses
	 ...
	 * @param direct       true: it is a direct subclass, false: it could be in the
	 *                     hierarchy
	 ...
	 * @return the classname, if the identifier does not exist, then null is
	 *         returned
	 * 
	 *         If there is an error in the ontology and the identifier is not
	 *         unique, then the first (randomly) is taken as the result
	 */
