...
public class CollectionSetUtilities {
     ...
     * 
     *         The JsonArray has the annotation information for each collection (for
     *         use in a pull down list)
     */
     ...
     * 
     *         The dataset information is annotated with the associated catalog
     *         name.
     * 
     */
     ...
     * 
     * @param catalogname:           The name of the catalog object associated with
     *                               the dataset
     * @param collectiondatasetinfo: The JsonArray of the dataset information
     * @return The identifier to be used within the collectiondatasetIDs (null if
     *         not found)
     * 
     */
