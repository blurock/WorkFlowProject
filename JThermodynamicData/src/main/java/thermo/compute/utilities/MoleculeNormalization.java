...
public class MoleculeNormalization {
	...
	public static void addHydrogens(IAtomContainer molecule) throws CDKException {
		...
		HydrogenPlacer placer = new HydrogenPlacer();
		placer.placeHydrogens2D(molecule, 1.5);
	}

	public static void normalizeMolecule(AtomContainer molecule, ThermoSQLConnection c)
