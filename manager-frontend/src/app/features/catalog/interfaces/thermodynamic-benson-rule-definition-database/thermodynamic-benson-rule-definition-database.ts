...
@Component({
  selector: 'app-thermodynamic-benson-rule-definition-database',
  standalone: true,
  ...
  template: `
    <app-base-minimum-database-object-structure
      [structure]="structure"
      [value]="value"
      [classname]="'dataset:ThermodynamicBensonRuleDefinitionDatabase'"
...
export class ThermodynamicBensonRuleDefinitionDatabaseComponent extends BaseSubclassComponent implements OnInit {
  override ngOnInit(): void {
    this.classname = 'dataset:ThermodynamicBensonRuleDefinitionDatabase';
    super.ngOnInit();
  }
}
