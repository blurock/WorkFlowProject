...
@Component({
  selector: 'app-j-thermodynamics-symmetry-structure-definition-database',
  standalone: true,
  ...
  template: `
    <app-base-minimum-database-object-structure
      [structure]="structure"
      [value]="value"
      [classname]="'dataset:JThermodynamicsSymmetryStructureDefinitionDatabase'"
...
export class JThermodynamicsSymmetryStructureDefinitionDatabaseComponent extends BaseSubclassComponent implements OnInit {
  override ngOnInit(): void {
    this.classname = 'dataset:JThermodynamicsSymmetryStructureDefinitionDatabase';
    super.ngOnInit();
  }
}
