...
@Component({
  selector: 'app-repository-parsed-to-fixed-block-size',
  standalone: true,
  ...
  template: `
    <app-base-minimum-database-object-structure
      [structure]="structure"
      [value]="value"
      [classname]="'dataset:RepositoryParsedToFixedBlockSize'"
...
export class RepositoryParsedToFixedBlockSizeComponent extends BaseSubclassComponent implements OnInit {
