...
@Component({
  selector: 'app-user-management-transaction-object',
  standalone: true,
  ...
  template: `
    <app-base-catalog-object
      [structure]="structure"
      [value]="value"
      [classname]="'dataset:UserManagementTransactionObject'"
      [isTransaction]="true"
      (valueChange)="updateValue($event)">
    </app-base-catalog-object>
  `
})
export class UserManagementTransactionObjectComponent extends BasePrimitiveComponent implements OnInit {
