...
@Component({
  selector: 'app-j-thermodynamics2d-molecule-thermodynamics-database',
  standalone: true,
  ...
  template: `
    <app-base-minimum-database-object-structure
      [structure]="structure"
      [value]="value"
      [classname]="'dataset:JThermodynamics2DMoleculeThermodynamicsDatabase'"
...
export class JThermodynamics2DMoleculeThermodynamicsDatabaseComponent extends BaseSubclassComponent implements OnInit {
  override ngOnInit(): void {
    this.classname = 'dataset:JThermodynamics2DMoleculeThermodynamicsDatabase';
    super.ngOnInit();
  }
}
