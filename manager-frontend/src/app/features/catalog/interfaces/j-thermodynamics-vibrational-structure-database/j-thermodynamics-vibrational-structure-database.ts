...
@Component({
  selector: 'app-j-thermodynamics-vibrational-structure-database',
  standalone: true,
  ...
  template: `
    <app-base-minimum-database-object-structure
      [structure]="structure"
      [value]="value"
      [classname]="'dataset:JThermodynamicsVibrationalStructureDatabase'"
...
export class JThermodynamicsVibrationalStructureDatabaseComponent extends BaseSubclassComponent implements OnInit {
  override ngOnInit(): void {
    this.classname = 'dataset:JThermodynamicsVibrationalStructureDatabase';
    super.ngOnInit();
  }
}
