...
@Component({
  selector: 'app-j-thermodynamics2d-substructure-thermodynamics-database',
  standalone: true,
  ...
  template: `
    <app-base-minimum-database-object-structure
      [structure]="structure"
      [value]="value"
      [classname]="'dataset:JThermodynamics2DSubstructureThermodynamicsDatabase'"
...
export class JThermodynamics2DSubstructureThermodynamicsDatabaseComponent extends BaseSubclassComponent implements OnInit {
  override ngOnInit(): void {
    this.classname = 'dataset:JThermodynamics2DSubstructureThermodynamicsDatabase';
    super.ngOnInit();
  }
}
