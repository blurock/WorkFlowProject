...
@Component({
  selector: 'app-j-thermodynamics-disassociation-energy-of-structure-database',
  standalone: true,
  ...
  template: `
    <app-base-minimum-database-object-structure
      [structure]="structure"
      [value]="value"
      [classname]="'dataset:JThermodynamicsDisassociationEnergyOfStructureDatabase'"
...
export class JThermodynamicsDisassociationEnergyOfStructureDatabaseComponent extends BaseSubclassComponent implements OnInit {
  override ngOnInit(): void {
    this.classname = 'dataset:JThermodynamicsDisassociationEnergyOfStructureDatabase';
    super.ngOnInit();
  }
}
