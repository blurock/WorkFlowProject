...
@Component({
  selector: 'app-j-thermodynamics2d-molecule-thermodynamics-data-set',
  standalone: true,
  ...
  template: `
    <app-base-minimum-database-object-structure
      [structure]="structure"
      [value]="value"
      [classname]="'dataset:JThermodynamics2DMoleculeThermodynamicsDataSet'"
...
export class JThermodynamics2DMoleculeThermodynamicsDataSetComponent extends BaseSubclassComponent implements OnInit {
  override ngOnInit(): void {
    this.classname = 'dataset:JThermodynamics2DMoleculeThermodynamicsDataSet';
    super.ngOnInit();
  }
}
