...
@Component({
  selector: 'app-j-thermodynamics-vibrational-structure-with-count',
  standalone: true,
  ...
  template: `
    <app-base-minimum-database-object-structure
      [structure]="structure"
      [value]="value"
      [classname]="'dataset:JThermodynamicsVibrationalStructureWithCount'"
...
export class JThermodynamicsVibrationalStructureWithCountComponent extends BaseSubclassComponent implements OnInit {
  override ngOnInit(): void {
    this.classname = 'dataset:JThermodynamicsVibrationalStructureWithCount';
    super.ngOnInit();
  }
}
