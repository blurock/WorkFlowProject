...
@Component({
  selector: 'app-j-thermodynamics-meta-atom-definition-database',
  standalone: true,
  ...
  template: `
    <app-base-minimum-database-object-structure
      [structure]="structure"
      [value]="value"
      [classname]="'dataset:JThermodynamicsMetaAtomDefinitionDatabase'"
...
export class JThermodynamicsMetaAtomDefinitionDatabaseComponent extends BaseSubclassComponent implements OnInit {
  override ngOnInit(): void {
    this.classname = 'dataset:JThermodynamicsMetaAtomDefinitionDatabase';
    super.ngOnInit();
  }
}
