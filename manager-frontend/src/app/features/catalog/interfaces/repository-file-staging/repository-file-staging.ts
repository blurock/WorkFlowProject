...
@Component({
  selector: 'app-repository-file-staging',
  standalone: true,
  ...
  template: `
    <app-base-minimum-database-object-structure
      [structure]="structure"
      [value]="value"
      [classname]="'dataset:RepositoryFileStaging'"
...
export class RepositoryFileStagingComponent extends BaseSubclassComponent implements OnInit {
  override ngOnInit(): void {
    this.classname = 'dataset:RepositoryFileStaging';
    super.ngOnInit();
  }
}
