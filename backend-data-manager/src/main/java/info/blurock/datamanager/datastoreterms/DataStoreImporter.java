...
public class DataStoreImporter {
    ...
    public static String importFromFirestore() {
        try (DocumentServiceClient client = DocumentServiceClient.create()) {
            ...
            com.google.api.gax.longrunning.OperationFuture<com.google.cloud.discoveryengine.v1.ImportDocumentsResponse, com.google.cloud.discoveryengine.v1.ImportDocumentsMetadata> future = client
